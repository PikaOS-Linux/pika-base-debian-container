...
chroot ./base_chroot /bin/bash -c "DEBIAN_FRONTEND=noninteractive apt-get update -y"
chroot ./base_chroot /bin/bash -c "DEBIAN_FRONTEND=noninteractive apt-get install -y wget"
...
chroot ./base_chroot /bin/bash -c "DEBIAN_FRONTEND=noninteractive apt-get install -y ./pika-pbuilder.deb "
